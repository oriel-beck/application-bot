...
export function formatInternationalResolvedDm(
    template: string,
    guildName: string,
    url: string
): string {
...
export function detectInternationalSupportLanguage(appliedTags: string[]): InternationalSupportLocale {
    ...
    for (const [locale, key] of Object.entries(LOCALE_TAG_KEYS) as [Exclude<InternationalSupportLocale, "en">, keyof InternationalSupportTagsConfig][]) {
