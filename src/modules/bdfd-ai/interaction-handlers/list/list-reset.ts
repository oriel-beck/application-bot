...
export class AiConversationListResetHandler extends InteractionHandler {
  public async run(interaction: ButtonInteraction) {
    ...
    const parsed = parseAiConversationChannelPageCustomId(interaction.customId, AiConversationCustomIDs.buttons.reset);
    if (!parsed) return;
  ...
  public parse(interaction: ButtonInteraction) {
    if (!parseAiConversationChannelPageCustomId(interaction.customId, AiConversationCustomIDs.buttons.reset)) {
      return this.none();
    }
    return this.some();
  }
