  ...
  public registerApplicationCommands(registry: Subcommand.Registry) {
    registry.registerChatInputCommand((builder) =>
      builder
        ...
        .addSubcommand((sub) =>
          sub
            ...
            .addStringOption((option) =>
              option.setName('channel-id').setDescription('The channel ID to delete the transcript for')
            )
        ...
        .addSubcommand((sub) =>
          sub.setName('clear-deleted').setDescription('Clear all transcripts that belong to deleted channels')
        )
        .addSubcommand((sub) =>
          sub
            .setName('get')
            ...
            .addStringOption((option) =>
              option.setName('channel-id').setDescription('The channel ID to get the transcript of')
            )
            .addChannelOption((option) =>
              option
                .setName('channel')
        ...
        .addSubcommand((sub) => sub.setName('list').setDescription('Browse and manage stored transcripts'))
    );
  }
}
