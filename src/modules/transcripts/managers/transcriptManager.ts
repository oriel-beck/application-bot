...
export default class TranscriptManager extends BaseManager {
  ...
  public async update(
    ...
    return await this.drizzle
      ...
      .where(eq(transcriptTable.channel, channel))
      .returning();
  }
  ...
  public async deleteMessage(channelId: string, messageId: string) {
    return await this.drizzle
      ...
      .where(and(eq(messagesTable.channel, BigInt(channelId)), eq(messagesTable.id, BigInt(messageId))));
  }
}
